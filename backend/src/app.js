...
const dietitiansRoutes = require('./routes/dietitians.routes');
...
const handibasketTeamManagementRoutes = require('./routes/handibasket_team_management.routes');
const teamProfilesRoutes = require('./routes/team_profiles.routes');
...
app.use('/api/handibasket-team-management', handibasketTeamManagementRoutes);
