-- Script de données de test pour le système de matching
-- Exécuter dans phpMyAdmin pour créer des équipes, joueurs et annonces avec abonnements premium

USE freeagent_db;

-- ================================================
-- 1. CRÉATION DES UTILISATEURS ÉQUIPES (PREMIUM)
-- ================================================

-- Équipes avec abonnements premium
...
-- ================================================
-- 2. CRÉATION DES PROFILS D'ÉQUIPES
-- ================================================
...
-- ================================================
-- 3. CRÉATION DES UTILISATEURS JOUEURS
-- ================================================
...
-- ================================================
-- 4. CRÉATION DES PROFILS JOUEURS
-- ================================================
...
-- ================================================
-- 5. CRÉATION DES ANNONCES DE RECRUTEMENT RÉALISTES
-- ================================================
...
-- ================================================
-- 6. CRÉATION DES ABONNEMENTS DANS LA TABLE SUBSCRIPTIONS
-- ================================================
...
-- ================================================
-- 7. INITIALISATION DES LIMITES UTILISATEURS
-- ================================================

INSERT INTO user_limits (user_id, applications_count, opportunities_posted, messages_sent, last_reset_date) VALUES
-- Limites équipes (peuvent poster plus d'annonces et contacter plus de joueurs)
...
-- ================================================
-- 8. VÉRIFICATION DES DONNÉES CRÉÉES
-- ================================================
